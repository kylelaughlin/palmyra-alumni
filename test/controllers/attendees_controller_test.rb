...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { event_option: @attendee.event_option, name: @attendee.name, rsvp_id: @attendee.rsvp_id } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { event_option: @attendee.event_option, name: @attendee.name, rsvp_id: @attendee.rsvp_id } }
