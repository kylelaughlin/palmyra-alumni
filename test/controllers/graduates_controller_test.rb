...
class GraduatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create graduate" do
    assert_difference('Graduate.count') do
      post graduates_url, params: { graduate: { class_year: @graduate.class_year, name: @graduate.name } }
    end
  ...
  test "should update graduate" do
    patch graduate_url(@graduate), params: { graduate: { class_year: @graduate.class_year, name: @graduate.name } }
