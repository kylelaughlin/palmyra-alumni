...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post rsvps_url, params: { rsvp: { classmate_id: @rsvp.classmate_id, payment_status: @rsvp.payment_status, total_cost: @rsvp.total_cost } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { classmate_id: @rsvp.classmate_id, payment_status: @rsvp.payment_status, total_cost: @rsvp.total_cost } }
